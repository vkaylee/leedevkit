...
|--------|---------|---------|
| `.agent/skills/geo-fundamentals/scripts/geo_checker.py` | GEO audit (AI citation readiness) | `python .agent/skills/geo-fundamentals/scripts/geo_checker.py <project_path>` |
