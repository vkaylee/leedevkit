...
|--------|---------|---------|
| `.agent/skills/geo-fundamentals/scripts/geo_checker.py` | GEO audit (AI citation readiness) | `.leedevkit/.venv/bin/python3 .agent/skills/geo-fundamentals/scripts/geo_checker.py <project_path>` |
