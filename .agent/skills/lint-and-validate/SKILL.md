...
description: Automatic quality control, linting, and static analysis procedures. Use after code modifications to ensure syntax correctness and project standards. Triggers on lint, format, check, validate, types, static analysis.
